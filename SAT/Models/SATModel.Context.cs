...
public partial class SATEntities : DbContext
{
    ...
    public virtual DbSet<tbHorarioDetalles> tbHorarioDetalles { get; set; }
    ...
    public virtual ObjectResult<UDP_Gral_tbMunicipios_Insert_Result> UDP_Gral_tbMunicipios_Insert(string mun_Id, string mun_Descripcion, Nullable<int> mun_UsuarioCrea, Nullable<System.DateTime> mun_FechaCrea, string dep_Id)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Gral_tbMunicipios_Insert_Result>("UDP_Gral_tbMunicipios_Insert", mun_IdParameter, mun_DescripcionParameter, mun_UsuarioCreaParameter, mun_FechaCreaParameter, dep_IdParameter);
    }
    ...
    public virtual ObjectResult<UDP_Gral_tbSecciones_Insert_Result> UDP_Gral_tbSecciones_Insert(string sec_Descripcion, Nullable<int> sec_UsuarioCrea, Nullable<System.DateTime> sec_FechaCrea, Nullable<int> jgra_Id)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Gral_tbSecciones_Insert_Result>("UDP_Gral_tbSecciones_Insert", sec_DescripcionParameter, sec_UsuarioCreaParameter, sec_FechaCreaParameter, jgra_IdParameter);
    }


    public virtual ObjectResult<UDP_Gral_tbSecciones_Update_Result> UDP_Gral_tbSecciones_Update(Nullable<int> sec_Id, string sec_Descripcion, Nullable<int> sec_UsuarioCrea, Nullable<System.DateTime> sec_FechaCrea, Nullable<int> sec_UsuarioModifica, Nullable<System.DateTime> sec_FechaModifica, Nullable<int> jgra_Id)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Gral_tbSecciones_Update_Result>("UDP_Gral_tbSecciones_Update", sec_IdParameter, sec_DescripcionParameter, sec_UsuarioCreaParameter, sec_FechaCreaParameter, sec_UsuarioModificaParameter, sec_FechaModificaParameter, jgra_IdParameter);
    }


    public virtual ObjectResult<UDP_Esc_tbMatriculas_Update_Result> UDP_Esc_tbMatriculas_Update(Nullable<int> mat_Id, Nullable<int> alu_Id, Nullable<int> esc_Id, Nullable<int> sec_Id, Nullable<int> car_Id, Nullable<int> mat_Anio, Nullable<int> mat_UsuarioCrea, Nullable<System.DateTime> mat_FechaCrea, Nullable<int> mat_UsuarioModifica, Nullable<System.DateTime> mat_FechaModifica)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Esc_tbMatriculas_Update_Result>("UDP_Esc_tbMatriculas_Update", mat_IdParameter, alu_IdParameter, esc_IdParameter, sec_IdParameter, car_IdParameter, mat_AnioParameter, mat_UsuarioCreaParameter, mat_FechaCreaParameter, mat_UsuarioModificaParameter, mat_FechaModificaParameter);
    }


    public virtual ObjectResult<UDP_Esc_tbMatriculas_Insert_Result> UDP_Esc_tbMatriculas_Insert(Nullable<int> alu_Id, Nullable<int> esc_Id, Nullable<int> sec_Id, Nullable<int> car_Id, Nullable<int> mat_Anio, Nullable<int> mat_UsuarioCrea, Nullable<System.DateTime> mat_FechaCrea)
    {
    ...
    public virtual ObjectResult<UDP_Esc_tbAlumnos_Insert_Result> UDP_Esc_tbAlumnos_Insert(string aLU_IDENTIDAD, string aLU_NOMBRES, string aLU_APELLIDOS, string aLU_SEXO, Nullable<System.DateTime> aLU_FECHANACIMIENTO, string aLU_DIRECCION, string mUN_ID, string aLU_NOMBRESENCARGADO, string aLU_APELLIDOSENCARGADO, string aLU_TELEFONOENCARGADO, Nullable<bool> aLU_ESACTIVO, string aLU_RAZONINACTIVO, Nullable<int> aLU_USUARIOCREA, Nullable<System.DateTime> aLU_FECHACREA, Nullable<int> aLU_USUARIOMODIFICA, Nullable<System.DateTime> aLU_FECHAMODIFICA)
    {
        ...
        var aLU_DIRECCIONParameter = aLU_DIRECCION != null ?
            new ObjectParameter("ALU_DIRECCION", aLU_DIRECCION) :
            new ObjectParameter("ALU_DIRECCION", typeof(string));
        ...
        var aLU_ESACTIVOParameter = aLU_ESACTIVO.HasValue ?
            new ObjectParameter("ALU_ESACTIVO", aLU_ESACTIVO) :
            new ObjectParameter("ALU_ESACTIVO", typeof(bool));


        var aLU_RAZONINACTIVOParameter = aLU_RAZONINACTIVO != null ?
            new ObjectParameter("ALU_RAZONINACTIVO", aLU_RAZONINACTIVO) :
            new ObjectParameter("ALU_RAZONINACTIVO", typeof(string));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Esc_tbAlumnos_Insert_Result>("UDP_Esc_tbAlumnos_Insert", aLU_IDENTIDADParameter, aLU_NOMBRESParameter, aLU_APELLIDOSParameter, aLU_SEXOParameter, aLU_FECHANACIMIENTOParameter, aLU_DIRECCIONParameter, mUN_IDParameter, aLU_NOMBRESENCARGADOParameter, aLU_APELLIDOSENCARGADOParameter, aLU_TELEFONOENCARGADOParameter, aLU_ESACTIVOParameter, aLU_RAZONINACTIVOParameter, aLU_USUARIOCREAParameter, aLU_FECHACREAParameter, aLU_USUARIOMODIFICAParameter, aLU_FECHAMODIFICAParameter);
    }
    ...
    public virtual ObjectResult<UDP_Gral_tbAsignaturas_Update_Result> UDP_Gral_tbAsignaturas_Update(Nullable<int> asig_Id, string asig_Descripcion, Nullable<bool> asig_Semestral, Nullable<int> asig_UsuarioCrea, Nullable<System.DateTime> asig_FechaCrea, Nullable<int> asig_UsuarioModifica, Nullable<System.DateTime> asig_FechaModifica)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<UDP_Gral_tbAsignaturas_Update_Result>("UDP_Gral_tbAsignaturas_Update", asig_IdParameter, asig_DescripcionParameter, asig_SemestralParameter, asig_UsuarioCreaParameter, asig_FechaCreaParameter, asig_UsuarioModificaParameter, asig_FechaModificaParameter);
    }


    public virtual ObjectResult<string> UDP_Gral_tbEmpleadoAsignaturas_Insert(Nullable<int> emp_Id, Nullable<int> asig_Id, Nullable<int> empa_UsuarioCrea, Nullable<System.DateTime> empa_FechaCrea)
    {
        ...
        var empa_UsuarioCreaParameter = empa_UsuarioCrea.HasValue ?
            new ObjectParameter("empa_UsuarioCrea", empa_UsuarioCrea) :
            new ObjectParameter("empa_UsuarioCrea", typeof(int));


        var empa_FechaCreaParameter = empa_FechaCrea.HasValue ?
            new ObjectParameter("empa_FechaCrea", empa_FechaCrea) :
            new ObjectParameter("empa_FechaCrea", typeof(System.DateTime));


        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("UDP_Gral_tbEmpleadoAsignaturas_Insert", emp_IdParameter, asig_IdParameter, empa_UsuarioCreaParameter, empa_FechaCreaParameter);
    }
